    ...
    <view class="home_content" :style="{ paddingTop: ht + 'px' }" @touchmove.stop.prevent="disabledScroll">
        ...
        <view class="restaurant_info">
          ...
          <view class="info_top">
            <view class="info_top_left">
              <image class="logo_ruiji" src="../../static/lodding.jpeg"></image>
            </view>
            <view class="info_top_right">
              ...
              <view class="right_details ">
				<view class="details_flex test ">
						<text class="icon_text ">广东潮汕地区的特色美食</text>
					</view>
				</view>			
            </view>
          </view>
          ...
          <view class="info_bottom">
            <view>
              <view class="word"> 隆江猪脚饭是一道广东潮汕地区的特色美食，以猪脚为主料，配以香料卤制，搭配米饭、咸菜、蚝仔米汤等食用。</view>
            </view>
            <view>
      ...
      <view class="footer_order_buttom" v-if="orderListData().length === 0 || shopStatus !== 1">
        <view class="order_number">
          <image src="../../static/btn_waiter.png" class="order_number_icon" mode=""></image>
        </view>
      ...
      <view class="pop_mask" v-show="loaddingSt">
        <view class="lodding">
          <image class="lodding_ico" src="../../static/lodding.jpeg" mode=""></image>
        </view>
      </view>
      <!-- 电话弹层 -->
	  ...
	  <uni-popup ref="inputDialog" type="dialog">
			<uni-popup-dialog ref="inputClose"  title="授权微信登录后才能点餐">
