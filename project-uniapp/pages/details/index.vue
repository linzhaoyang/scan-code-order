  ...
  <view>
    ...
    <view class="order_content orderDetail">
      <view class="order_content_box" scroll-y="true" scroll-top="0rpx">
        <!-- 支付状态 -->
        <status ref="status" :timeout="timeout" :orderDetailsData="orderDetailsData" :rocallTime="rocallTime" :showConfirm="showConfirm" :textTip="textTip"
          @statusWord="statusWord" @paymentTime="paymentTime" @handlePay="handlePay" @handleReminder="handleReminder" @oneMoreOrder="oneMoreOrder" @handleCancel="handleCancel">
        </status>
        <!-- end -->
        <!-- 订单详情 -->
      ...
      <view class="container phoneCon">
        <uni-popup ref="phone"  class="popupBox">
          <view class="popup-content">
            <view>{{ phone }}</view>
