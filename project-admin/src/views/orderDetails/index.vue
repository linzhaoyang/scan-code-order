  ...
  <div class="dashboard-container">
    ...
    <div class="container" :class="{ hContainer: tableData.length }">
      ...
      <el-table
        ...
        class="tableBox"
      >
        <el-table-column key="number" prop="number" label="订单号" width="140px" />
        <el-table-column
          v-if="[2,3].includes(orderStatus)"
          key="orderDishes"
          prop="orderDishes"
          label="订单菜品"
        />
        ...
        <el-table-column
          v-if="[0, 4, 5].includes(orderStatus)"
          key="consignee"
          prop="userName"
          label="用户名"
        ...
        />
        <el-table-column
          v-if="[0, 2, 3, 4, 5].includes(orderStatus)"
          key="type"
        ...
        />
        <el-table-column
          v-if="[0, 2,3].includes(orderStatus)"
          key="orderTime"
          prop="orderTime"
          label="下单时间"
        ...
        <el-table-column
          ...
          :min-width="[5].includes(orderStatus) ? 80 : 'auto'"
        />
        <el-table-column
          v-if="[4].includes(orderStatus)"
          key="deliveryTime"
          prop="deliveryTime"
          label="完成时间"
        />
    ...
    >
      ...
      <span slot="footer" class="dialog-footer">
        ...
        >完 成</el-button>
        <el-button
          v-if="[3].includes(dialogOrderStatus)"
          type="primary"
          @click="cancelOrder(row)"
        >取消订单</el-button>
      </span>
